...
// ==========================================
// 2. MOTEUR DU JEU ET INJECTION DE TEST
// ==========================================
let filiereActuelle = "";
let niveauActuel = 0;
...
function chargerNiveau() {
    ...
    // INJECTION AUTOMATIQUE DE TEST : Positionnement strict en A1, C4 et E8
    ...
    // Création des Hitbox (invisibles par défaut)
...
document.getElementById('btn-passer-mission').addEventListener('click', () => {
    if (anomaliesTrouvees < anomaliesTotales) {
        ...
        historiqueResultats.push('rouge'); 
    } else if (anomaliesTotales === 0) {
        historiqueResultats.push('vert'); 
    } else {
        historiqueResultats.push('vert'); 
    }
    niveauActuel++;
...
// Rendre les zones visibles au clic sur le bouton Aide
